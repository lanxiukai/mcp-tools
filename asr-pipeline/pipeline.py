...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        "-n", "--num-speakers", type=_positive_int, default=None,
        help="Set the exact expected number of speakers for diarization.",
    )
    p.add_argument(
    ...
    p.add_argument(
        ...
        help="Skip word-level timestamps (fast mode). "
             ...
             "Speaker timelines remain separate from the full transcript. "
